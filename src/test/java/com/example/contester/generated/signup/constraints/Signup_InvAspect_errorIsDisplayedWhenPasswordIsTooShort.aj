 ...
 * @Generated
 */
public privileged aspect Signup_InvAspect_errorIsDisplayedWhenPasswordIsTooShort {
     ...
     * <code>context Signup
     *       inv errorIsDisplayedWhenPasswordIsTooShort: self.password <> '' and self.password.size() < 8 implies self.passwordErrorMessage = 'Password must be at least 8 characters'</code>
    ...
    before(com.example.contester.generated.signup.Signup aClass) : allSignupPublicMethods(aClass) {
        ...
        if (!(!(!aClass.password.equals("") && (aClass.password.length() < new Integer(8))) || aClass.passwordErrorMessage.equals("Password must be at least 8 characters"))) {
        	// TODO Auto-generated code executed when constraint is violated.
        	String msg = "Error: Constraint 'errorIsDisplayedWhenPasswordIsTooShort' (inv errorIsDisplayedWhenPasswordIsTooShort: self.password <> '' and self.password.size() < 8 implies self.passwordErrorMessage = 'Password must be at least 8 characters') was violated for Object " + aClass.toString() + ".";
